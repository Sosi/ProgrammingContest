...
class NetworkXZeroOne
{
 public:
        string reconstruct(string message)
        {
            ...
            {
                if(message[i]=='o'){o=i;break;}
                if(message[i]=='x'){x=i;break;}
            }
            if(o!=-1)
            {
                for(int i=o-1;i>=0;i--){if(o%2==i%2)message[i]='o';else message[i]='x';}
                for(int i=o+1;i<message.size();i++){if(o%2==i%2)message[i]='o';else message[i]='x';}
            }
            if(x!=-1)
            {
                for(int i=x-1;i>=0;i--){if(x%2==i%2)message[i]='x';else message[i]='o';}
                for(int i=x+1;i<message.size();i++){if(x%2==i%2)message[i]='x';else message[i]='o';}
            }
            return message;
                //$CARETPOSITION$
        }
