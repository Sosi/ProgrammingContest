...
class DividingIntoTeams
{
        ...
        {
            int n= alexFriends.size();
            vector<int> Num(n+1,0);
            for(int i=1; i<=n;)
            {
                for(int j=0; j<n; j++)
                {
                    if(Num[alexFriends[j]]==0)
                    {
                        Num[alexFriends[j]]=1;
                        i++;
                        if(alexFriends[j]==k) return "Alex";
                        break;
                    }
                }
                for(int j=0; j<n;j++)
                {
                    if(Num[bobFriends[j]]==0)
                    {
                        Num[bobFriends[j]]=1;
                        i++;
                        if(bobFriends[j]==k) return "Bob";
                        break;
                    }
                }
                for(int j=0; j<n; j++)
                {
                    if(Num[charlieFriends[j]]==0)
                    {
                        Num[charlieFriends[j]]=1;
                        i++;
                        if(charlieFriends[j]==k) return "Charlie";
                        break;
                    }
                }
            }
