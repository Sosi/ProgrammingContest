...
// END CUT HERE
#line 5 "LeftRightDigitsGame.cpp"
...
string NonZero(string d)
{
    cout<<"d "<<d<<endl;
    string ret = d.substr(0,1);
    ...
    public:
        string minNumber(string digits)
        {
            ...
            if(zero)
            {
                ...
                cout<<" id "<<id<<endl;
                return digits[id] + NonZero(digits.substr(0,id))+ digits.substr(id+1,digits.size() - id);

            }
            else return NonZero(digits);
        }
