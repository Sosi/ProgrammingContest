...
// END CUT HERE
#line 5 "ApproximateDivision.cpp"
...
class ApproximateDivision
{
        ...
        double quotient(int a, int b, int terms)
        {
			...
			return a*total;
			//int x=ceil(log(b*1.0)/log(2.0));
		//	long double t=pow(2.0,x);
			//cout<<t<<endl;
			//return (long double)a/(long double)b*(1-(long double)pow((t-(long double)b)/t,(long double)terms));
        }
