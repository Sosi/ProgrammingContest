...
public:
	double theMax(int nA, int nB, int paramA, int paramB)
	{
		...
		if(paramA>=0)
		{
			if(paramB>=-1000 && paramB<=1000)
				return nA*1.0*paramA/1000;
			...
			if(paramB>1000)
			{
				...
				if(nA * paramA>1000)
				{
					return res*nA*paramA/1000;
				}
				if(nA* paramA<1000)
				{
					return res+1.0*nA*paramA/1000;
				}
			}
			if(paramB<-1000)
			{
				...
				if(nA * paramA> 1000)
				{
					return res*nA*(paramA*1.0/1000);
				}
				if(nA * paramA< 1000)
				{
					return res+nA*(1.0*paramA/1000);
				}
			}
		}
		else
		{
			...
			if(paramB>1000)
				return nA*1.0*paramA/1000;
			for(int i=0;i<nB;i++)
				res*=paramB*1.0/1000.0;
			if(paramB>=0)
				return nA*1.0*paramA*res;
			res=1.0;
			if(nB%2==0)
				nB--;
			for(int i=0;i<nB;i++)
			...
			else
			{
				...
				if(nA* paramA<-1000 && nB!=0 )
				{
					return nA*paramA*1.0/1000*paramB/1000;
				}
				if(nA* paramA<-1000 && nB==0 )
				{
					return nA*paramA*1.0/1000;
				}
				if(nB!=0)
					return nA*paramA/1000.0*paramB/1000;
				else
					return nA*paramA*1.0/1000;
			}
