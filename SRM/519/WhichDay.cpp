...
class WhichDay
{
        ...
        {
            //notOnThisDay.push_back()
            vector<string> Week;
            Week.push_back("Sunday");
            Week.push_back("Monday");Week.push_back("Tuesday");
            Week.push_back("Wednesday"); Week.push_back("Thursday");
            Week.push_back("Friday");Week.push_back("Saturday");
            sort(Week.begin(),Week.end());
            sort(notOnThisDay.begin(),notOnThisDay.end());
            for(int i=0;i<notOnThisDay.size();i++)
            {
                if(Week[i]!=notOnThisDay[i]) return Week[i];
            }
