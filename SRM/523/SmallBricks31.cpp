...
private:
    ...
    void test_case_1()
    {
        ...
        int Arg1 = 1;
        int Arg2 = 13;
        verify_case(1, Arg2, countWays(Arg0, Arg1));
    }
    void test_case_2()
    {
        int Arg0 = 3;
        int Arg1 = 2;
        int Arg2 = 84;
        verify_case(2, Arg2, countWays(Arg0, Arg1));
    }
    void test_case_3()
    {
        int Arg0 = 4;
        int Arg1 = 9;
        int Arg2 = 132976888;
        verify_case(3, Arg2, countWays(Arg0, Arg1));
    }
    void test_case_4()
    {
        int Arg0 = 5;
        int Arg1 = 5;
        int Arg2 = 11676046;
        verify_case(4, Arg2, countWays(Arg0, Arg1));
    }
