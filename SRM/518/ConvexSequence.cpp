...
{
    for(int i=a.size(); i>0; i--) //form big to small
    {
        if(a[i]<a[i-1])
        {
            res+=a[i-1]-a[i];
...
void cal(vector<int> & a)
{
    ...
    for(int j=a.size()-1; j>0; j--)
    {
        for(int i=0; i<a.size()-1; i++)
        {
            while(i<j)
            {
                long long b=(a[i]*(j-i-1.0)+a[j])/(j-i);
                if(a[i+1]>b)
                {
                    res+=a[i+1]-b;
                    a[i+1]=b;
                ...
                long long c=(a[j]*(j-i-1.0)+a[i])/(j-i);
                if(a[j-1]>c)
                {
                    res+=a[j-1]-c;
                    a[j-1]=c;
...
public:
    long long getMinimum(vector <int> a)
    {
        ...
        vector<int> b;
        vector<int> c;
        for(int i=pos; i>=0; i--) b.push_back(a[i]);
        for(int i=pos; i<a.size(); i++) c.push_back(a[i]);
        process(b);
        process(c);
...
private:
    ...
    void test_case_0()
    {
        int Arr0[] = {6,5,1,5,3,3};
        vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        long long Arg1 = 7LL;
        verify_case(0, Arg1, getMinimum(Arg0));
    }
    void test_case_1()
    {
        int Arr0[] = {3,0,1,4};
        vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        long long Arg1 = 0LL;
        verify_case(1, Arg1, getMinimum(Arg0));
    }
    void test_case_2()
    {
        int Arr0[] = {1,1,1,0,2,2,2};
        vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        long long Arg1 = 5LL;
        verify_case(2, Arg1, getMinimum(Arg0));
    }
    void test_case_3()
    {
        int Arr0[] = {854159326, 317144183, 781399725, 287076509, 894967145, 882577367, 174517516, 134415519,
        ...
        vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        long long Arg1 = 20178337330LL;
        verify_case(3, Arg1, getMinimum(Arg0));
    }
    void test_case_4()
    {
        int Arr0[] = {5};
        vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        long long Arg1 = 0LL;
        verify_case(4, Arg1, getMinimum(Arg0));
    }
