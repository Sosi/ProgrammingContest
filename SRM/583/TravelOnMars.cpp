...
class TravelOnMars
{
    public:
        int minTimes(vector <int> range, int startCity, int endCity)
        {
            ...
            int N = range.size();
            for(int i=0; i<55; i++)for(int j=0;j<55; j++) dis[i][j] = 100000;
    ...
    private:
        ...
        void test_case_0() { int Arr0[] = {14, 1, 6, 13, 15, 12, 13, 13, 13, 3, 7, 7, 2, 15, 5, 12, 11, 10, 13, 6, 6, 13, 5, 6, 14, 10, 10, 7, 5, 10, 9, 1, 10, 6, 5, 11, 1, 4, 10, 4, 14, 10, 2, 12, 13, 12, 2, 15, 11, 4}; vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 49; int Arg2 = 19; int Arg3 = 3; verify_case(0, Arg3, minTimes(Arg0, Arg1, Arg2)); }
